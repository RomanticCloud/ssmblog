...
<body>
<div id="addDlg">
    <form id="fm" method="post" target="_parent" action="${pageContext.request.contextPath}/admin/blogType/update">
        <input type="hidden" id="id" name="id" class="layui-input" style="width: 90%" required>
